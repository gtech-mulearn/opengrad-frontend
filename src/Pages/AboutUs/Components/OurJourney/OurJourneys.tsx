          ...
          <div className="timelineComponent">
            ...
            <div className="timelineItem">
              <div id="timelineLeftVerified" className="timelineLeft">
                <div className="timelineDateText">January 2012</div>
              </div>
            ...
            <div className="timelineItem">
              <div id="timelineLeftVerified" className="timelineLeft">
                <div className="timelineDateText">June 2016</div>
              </div>
              <div id="timelineCenterVerified" className="timelineCentre">
                <div className="timelineCircle"></div>
              </div>
            ...
            <div className="timelineItem">
              <div id="timelineLeftVerified" className="timelineLeft">
                <div className="timelineDateText">August 2017</div>
              </div>
              <div id="timelineCenterVerified" className="timelineCentre">
                <div className="timelineCircle"></div>
              </div>
              <div className="timelineRight">
                ...
                <div className="marginBottomXlarge">
                  <p className="textColourLightgrey">
                ...
                <div className="timelineImageWrapper marginBottomMedium">
                  <img
                ...
                <div className="timelineQuoteWrapper">
                  <img
                    src="https://assets.website-files.com/60dd72519d9f9f67690ae425/60de52655aae394d43a0ac08_Dan.jpg"
                    loading="lazy"
                    alt=""
                    className="timelineQuoteImage"
                  />
                  <div className="timelineQuoteTextWrapper">
                    <p className="timelineQuote">
                    ...
                    <p className="timelineQuoteTitle">
            ...
            <div className="timelineItem">
              <div id="timelineLeftVerified" className="timelineLeft">
                <div className="timelineDateText">April 2018</div>
              </div>
              <div id="timelineCenterVerified" className="timelineCentre">
                <div className="timelineCircle"></div>
              </div>
            ...
            <div className="timelineItem">
              <div id="timelineLeftVerified" className="timelineLeft">
                <div className="timelineDateText">June 2018</div>
              </div>
              <div id="timelineCenterVerified" className="timelineCentre">
                <div className="timelineCircle"></div>
              </div>
            ...
            <div className="timelineItem">
              <div id="timelineLeftVerified" className="timelineLeft">
                <div className="timelineDateText">November 2019</div>
              </div>
              <div id="timelineCenterVerified" className="timelineCentre">
                <div className="timelineCircle"></div>
              </div>
              <div className="timelineRight">
                ...
                <div className="marginBottomXlarge">
                  <div className="timelineDefinitionWrapper">
                    <p className="textColourWhite">
                      relume
                      <br />
                    </p>
                    ...
                    <p className="textColourLightgrey">
                      [ri-loom]
                      <br />
                      <span className="textColourWhite">
            ...
            <div className="timelineItem">
              <div id="timelineLeftVerified" className="timelineLeft">
                <div className="timelineDateText">January 2020</div>
              </div>
              <div id="timelineCenterVerified" className="timelineCentre">
                <div className="timelineCircle"></div>
              </div>
            ...
            <div className="timelineItem">
              <div id="timelineLeftVerified" className="timelineLeft">
                <div className="timelineDateText">April 2020</div>
              </div>
              <div id="timelineCenterVerified" className="timelineCentre">
                <div className="timelineCircle"></div>
              </div>
              <div className="timelineRight">
                <div className="timelineMilestoneBadge">
            ...
            <div className="timelineItem">
              <div id="timelineLeftVerified" className="timelineLeft">
                <div className="timelineDateText">June 2020</div>
              </div>
              <div id="timelineCenterVerified" className="timelineCentre">
                <div className="timelineCircle"></div>
              </div>
